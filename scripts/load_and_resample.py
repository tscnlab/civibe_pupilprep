...
def main():
    ...
    save_raw = (
        True  # do you want to save the loaded and marked raw data and protocol files?
    )
    save_path_raw = (
        "./results/raw/"  # must exist! add a slash at the end to avoid incorrect saving
    )
