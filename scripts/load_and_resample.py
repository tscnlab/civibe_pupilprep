...
def main():
    ...
    sampling_frequency = 30   #frequency to resample to
    ...
    for participant_id in participant_list:
        ...
        print(str(participant_id)+' :Loading data and resampling to '+str(sampling_frequency)+'...')
        ...
        data_df = prep.resample_by_trial(data_df,sample_freq = sampling_frequency)
        
        print('Saving resampled data...')
        resampled_fp = str(participant_id)+'_'+str(sampling_frequency)+'_resampled_data.csv'
